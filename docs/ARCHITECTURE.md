...
Regex-based detection of 116 known attack patterns loaded from `tweek/config/patterns.yaml`.
...
| `tweek/config/patterns.yaml` | Bundled | 116 attack pattern definitions with regex, severity, description |
...
|   +-- patterns.yaml              # 116 attack pattern definitions
