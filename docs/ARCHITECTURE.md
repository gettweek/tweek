...
Regex-based detection of 215 known attack patterns loaded from `tweek/config/patterns.yaml`.
...
| `tweek/config/patterns.yaml` | Bundled | 215 attack pattern definitions with regex, severity, description |
...
|   +-- patterns.yaml              # 215 attack pattern definitions
